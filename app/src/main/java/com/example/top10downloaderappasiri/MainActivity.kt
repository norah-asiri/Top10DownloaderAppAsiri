package com.example.top10downloaderappasiri
...
class MainActivity : AppCompatActivity() {
    ...
    val URL = "http://ax.itunes.apple.com/WebObjects/MZStoreServices.woa/ws/RSS/topfreeapplications/limit=10/xml"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnFeed = findViewById(R.id.fetch_btn)
